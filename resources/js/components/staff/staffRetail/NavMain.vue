...
const items: NavItem[] = [
  {
    title: 'Dashboard',
    icon: HomeIcon,
    href: 'staffpanel.staffretail.Dashboard',
  },
  {
    title: 'Order Products',
    icon: ClipboardDocumentListIcon,
    href: 'staffpanel.staffretail.Order',
  },
  {
    title: 'Purchased Items',
    icon: ClipboardDocumentListIcon,
    href: 'staffpanel.staffretail.PurchasedItems',
  },
  {
    title: 'Contact Manager',
    icon: ChatBubbleLeftRightIcon,
    href: 'staffpanel.staffretail.ContactManager',
  },
  {
    title: 'Feedback & Questions',
    icon: ChatBubbleLeftRightIcon,
    href: 'staffpanel.staffretail.FeedbackQuestion',
  },
];
