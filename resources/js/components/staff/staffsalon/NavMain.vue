...
const items: NavItem[] = [
  {
    title: 'Dashboard',
    icon: HomeIcon,
    href: `staffpanel.staffsalon.Dashboard`,
  },
  {
    title: 'Order Products',
    icon: ClipboardDocumentListIcon,
    href: `staffpanel.staffsalon.Order`,
  },
  {
    title: 'Purchased Items',
    icon: ClipboardDocumentListIcon,
    href: `staffpanel.staffsalon.PurchasedItems`,
  },
  {
    title: 'Contact Manager',
    icon: ChatBubbleLeftRightIcon,
    href: `staffpanel.staffsalon.ContactManager`,
  },
  {
    title: 'Feedback & Questions',
    icon: ChatBubbleLeftRightIcon,
    href: `staffpanel.staffsalon.FeedbackQuestion`,
  },
];
</script>
