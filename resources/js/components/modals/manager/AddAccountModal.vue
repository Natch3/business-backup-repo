...
function submit() {
  ...
  form.post(route("manager.AddAccount.store"), {
    preserveScroll: true,
    onSuccess: () => {
      form.reset('password', 'password_confirmation');
      fileItems.value = [];
      ElMessage.success("User Staff created successfully!");
...
>
  Add Staff Account
    ...
    <el-dialog v-model="dialogVisible" title="Add Staff Account"  :width="dialogWidth"
  class="custom-modal">
<div style="width: 100%">
...
<el-select
  ...
  style="width: 100%; min-height: 35px; white-space: normal;"
  required
>
  <el-option
