...
function submit() {
  ...
  form.post(route("admincontrol.UserSubscription.store"), {
    preserveScroll: true,
    onSuccess: () => {
...
>
  Add Owner Account
    ...
    <el-dialog v-model="dialogVisible" title="Add Owner Account"  :width="dialogWidth"
  class="custom-modal">
<div style="width: 100%">
...
<div style="margin-top: 10px; width: 100%">
  <label for="subscription_duration" style="display: block; margin-bottom: 5px; font-weight: 500; color: #303133;">
    Subscription Duration
  </label>
  <el-select
    v-model="form.subscription_duration"
    placeholder="Select subscription"
    style="width: 100%; height: 35px"
    required
  >
    <el-option label="1 Month" value="1_month" />
    <el-option label="1 Year" value="1_year" />
  </el-select>
  <InputError class="mt-2" :message="form.errors.subscription_duration" />
</div>


<div style="margin-top: 10px; width: 100%">
  <label for="branch_limit" style="display: block; margin-bottom: 5px; font-weight: 500; color: #303133;">
    Branch Limit
  </label>
  <el-select
    v-model="form.branch_limit"
    placeholder="Select Branch Limit"
    style="width: 100%; height: 35px"
    required
  >
  ...
  <InputError class="mt-2" :message="form.errors.branch_limit" />
</div>
