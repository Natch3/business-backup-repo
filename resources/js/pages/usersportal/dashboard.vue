 ...
 <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4  lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div class="flex flex-col justify-center">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Empowering businesses with smart, cloud-based solutions.</h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Our system provides an intuitive and secure platform for managing sales, inventory, staff, and reports — designed for retail stores, restaurants, salons, and service-based industries.</p>
