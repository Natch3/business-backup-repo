        ...
        <li className="flex items-center justify-between p-4 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 truncate w-40 dark:text-gray-200">Hey, are you available today?</p>
            </div>
          </div>
          <div className="text-xs text-gray-400 whitespace-nowrap dark:text-gray-300">10:45 AM</div>
        </li>
        <li className="flex items-center justify-between p-4 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
          <div className="flex items-center space-x-4">
            <div className="relative">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 truncate dark:text-gray-200 w-40">Sure, let's talk later.</p>
            </div>
          </div>
          <div className="text-xs text-gray-400 whitespace-nowrap dark:text-gray-300">Yesterday</div>
        </li>
      </ul>
    </div>
  </div>
