...
const breadcrumbs: BreadcrumbItem[] = [
  {
    title: 'Owner Message',
    href: '/manager/OwnerMessage',
  },
];
</script>
<template>
  <Head title="Owner Message" />
  <Suspense>
    <template #default>
...
<div className="w-full lg:w-80 bg-white border-r border-gray-200 dark:bg-transparent dark:border-white">
    <div className="max-w-md mx-auto rounded-lg overflow-hidden">
      <div className="p-4 border-b dark:border-b-white">
      ...
      <ul className="divide-y divide-gray-200 dark:divide-white">
        ...
        <li className="flex items-center justify-between p-4 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
          <div className="flex items-center space-x-4">
            <div className="relative">
              <img className="w-10 h-10 rounded-full object-cover"   :src="LogoImage" alt="User Avatar" />
              <span className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-white rounded-full" />
            </div>
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">John Doe</p>
              <p className="text-xs text-gray-500 truncate w-40 dark:text-gray-400">Hey, are you available today?</p>
            </div>
          </div>
          <div className="text-xs text-gray-400 whitespace-nowrap dark:text-gray-400">10:45 AM</div>
        </li>
        <li className="flex items-center justify-between p-4 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
          <div className="flex items-center space-x-4">
            <div className="relative">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 truncate dark:text-gray-400 w-40">Sure, let's talk later.</p>
            </div>
          </div>
          <div className="text-xs text-gray-400 whitespace-nowrap dark:text-gray-400">Yesterday</div>
        </li>
      </ul>
    </div>
  </div>
...
<div className="hidden lg:flex-1 lg:flex lg:flex-col">
    <div className="flex-1 overflow-y-auto p-6">
      <div className="text-center">
        ...
        <p className="mt-3 text-gray-600 dark:text-gray-200">Your AI-powered copilot for the web</p>
      </div>

      <ul className="mt-10 space-y-5">
        <li className="flex gap-x-4">
          <div className="shrink-0 size-10 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold">
            AI
          </div>
          <div className="inline-block bg-white border dark:bg-transparent border-gray-200 rounded-lg p-4 space-y-3">
            <h2 className="font-medium text-gray-800 dark:text-gray-100">How can we help?</h2>
        ...
        <li className="flex justify-end gap-x-4">
          <div className="text-end space-y-3">
            <div className="inline-block bg-blue-600 rounded-lg p-4 shadow text-white text-sm">
              What's Preline UI?
            </div>
          </div>
          <span className="shrink-0 size-10 rounded-full bg-gray-600 flex items-center justify-center text-white font-medium">
            AZ
          </span>
        </li>
      </ul>
    ...
    <div className="border-t bg-transparent p-4">
      <div className="relative">
        <textarea
          className="w-full p-4 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-blue-500 focus:outline-none"
          rows={2}
