...
const breadcrumbs: BreadcrumbItem[] = [
  {
    ...
    href: '/SubscriptionExpired/Expired',
  },
];
...
<img src="../../assets/img/logo/sam.png" class="hidden dark:inline"   style="width: 150px; height: auto" alt="Anggot Logo">
  ...
  <Link
       v-if="$page.props.auth.user"
                    :href="route('usersportal.dashboard')"
  ...
  <section class="bg-white dark:bg-gray-900 py-12 mt-22">
...
class="fixed bottom-0 end-0 z-60 sm:max-w-xl w-full mx-auto p-6">
  ...
  <div class="p-4 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-800">
   ...
   <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
          Subscribe now to fully access the new features. <a class="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="#">Contact our Admin</a> to learn more.
        </p>
        <div class="mt-5 inline-flex gap-x-2">
          <button type="button" class="py-2 cursor-pointer px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
          Subscribe Now
          </button>
          <button
             @click="dismissCookies"
          type="button" class="py- cursor-pointer px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700">
           Close
          </button>
        </div>
      </div>
...
<!-- <Link href="/login" class="text-red-600 underline">Return to Login</Link> -->
